...
console.log(`The Subtractio of ${x} - ${y} = `, calculator(x,y,sub));
console.log(`The Mutiplication of ${x} * ${y} = `, calculator(x,y,multi));
console.log(`The Division of ${x} / ${y} = `, calculator(x,y,div));
console.log(`The Average of ${x} + ${y} / 2 = `, calculator(x,y,avg));
